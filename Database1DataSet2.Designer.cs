...
namespace payment {
    ...
    public partial class Database1DataSet2 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string company_name, double ratio) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow FindBycompany_name(string company_name) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public double ratio {
                get {
                    return ((double)(this[this.tableTable.ratioColumn]));
                }
                set {
                    this[this.tableTable.ratioColumn] = value;
                }
            }
        }
...
namespace payment.Database1DataSet2TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([company name] = @Original_company_name) AND ([" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([company name], [ratio]) VALUES (@company_name, @ratio" +
                ");\r\nSELECT [company name], ratio FROM [Table] WHERE ([company name] = @company_n" +
                "ame)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [company name] = @company_name, [ratio] = @ratio WHERE (" +
                "([company name] = @Original_company_name) AND ([ratio] = @Original_ratio));\r\nSEL" +
                "ECT [company name], ratio FROM [Table] WHERE ([company name] = @company_name)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [company name], ratio FROM dbo.[Table]";
        ...
        public virtual int Delete(string Original_company_name, double Original_ratio) {
        ...
        public virtual int Insert(string company_name, double ratio) {
        ...
        public virtual int Update(string company_name, double ratio, string Original_company_name, double Original_ratio) {
            if ((company_name == null)) {
                throw new global::System.ArgumentNullException("company_name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(double ratio, string Original_company_name, double Original_ratio) {
            return this.Update(Original_company_name, ratio, Original_company_name, Original_ratio);
        }
    }
